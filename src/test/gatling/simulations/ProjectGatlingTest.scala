...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "statu":null, "descript1":"SAMPLE_TEXT", "descript2":"SAMPLE_TEXT", "descript3":"SAMPLE_TEXT", "descript4":"SAMPLE_TEXT", "startTime":"SAMPLE_TEXT", "completeTime":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
